// Preloaded default panda images
const defaultImages = [
    { name: "吃竹子熊貓", url: "assets/panda1.png" },
    { name: "爬樹小熊貓", url: "assets/panda2.png" },
    { name: "睡覺胖熊貓", url: "assets/panda3.png" }
];

// App State
let selectedImage = defaultImages[0].url;
let gridSize = 5; // 5x5 default for Panda Puzzle
let isPlaying = false;
let timeElapsed = 0;
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Set default css grid-size variable to 5
